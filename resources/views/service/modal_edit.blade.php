    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-pencil"></i> Edit Service</h4>
            </div>
            <form method="post" id="frm-edit-service">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" readonly id="unit" name="unit" required>
                            </div>
                        </div>
